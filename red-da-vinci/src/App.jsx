...
function App() {
  ...
  const handleRegisterSubmit = (e) => {
    ...
    setActiveTab('home');
    alert(`¡Registro exitoso, ${newUser.name}! Tu cuenta ha sido creada.`);
  };
      ...
      <div className="relative z-10 flex flex-col justify-between min-h-screen drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)]">
        ...
        <header className="flex flex-col items-center text-center py-2 px-5 bg-black/20 backdrop-blur-md border border-[#f3e5ab]/30 rounded-xl w-fit mx-auto shadow-lg">
          ...
          <div className="mt-1 inline-flex items-center gap-2 bg-black/30 px-3 py-0.5 rounded-full border border-[#f3e5ab]/30 text-[10px]">
            <span className="text-gray-200">Pozo Cooperativo:</span>
              ...
              {currentUser ? (
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div>
                    ...
                    <span className={`text-[9px] px-1.5 py-0.5 mt-0.5 rounded-full border block w-fit ${currentUser.curated ? 'bg-green-950/60 text-green-300 border-green-500/40' : 'bg-gray-800 text-gray-300 border-gray-600'}`}>
                      {currentUser.curated ? '✓ Artista Verificado' : '🌐 Perfil Público'}
                    </span>
                  </div>
                  <button onClick={handleLogout} className="ml-2 text-[10px] text-red-400 hover:text-red-200 cursor-pointer">Salir</button>
                </div>
              ) : (
                <div>
                ...
                <div>
                  ...
                  <form onSubmit={handleRegisterSubmit} className="space-y-2.5 text-xs">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        <label className="text-gray-300 text-[10px] block mb-0.5">Confirmar Contraseña:</label>
